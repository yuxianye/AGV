...
namespace Solution.Device.Core
{
    ...
    public delegate void DeviceNotificationEventHandler(IDevice device, DeviceEventArgs<DeviceParamEntityBase> deviceEventArgs);
    ...
    public interface IDevice
    {
        ...
        Task<Tout> Connect<Tin, Tout>(Tin connectParam) where Tin : IDeviceParam where Tout : IDeviceParam;
