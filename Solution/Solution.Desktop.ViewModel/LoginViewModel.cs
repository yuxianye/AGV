    ...
    public class LoginViewModel : VmBase
    {
        ...
        private void OnExecuteLoginCommand()
        {
            try
            {
                ...
                stopwatch.Start();
#endif
                var result = Utility.Http.HttpClientHelper.PostResponse<OperationResult<PageResult<MenuModule>>>(GlobalData.ServerRootUri + "Identity/Login", Utility.JsonHelper.ToJson(LoginUser));
